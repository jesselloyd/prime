...
unrealRootPath=/home/jason/Documents/_repos/UnrealEngine/4.15/UnrealEngine
PrimerRootPath=/home/jason/Documents/_repos/Prime/prime/Primer

gameProjectFile=/home/jason/Documents/_repos/Prime/prime/Primer/Primer.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(PrimerSource.pri)
include(PrimerHeader.pri)
include(PrimerConfig.pri)
include(PrimerIncludes.pri)
include(PrimerDefines.pri)
...
Primer-Linux-Debug.commands = $$build Primer Linux Debug  -project="\"$$gameProjectFile\"" $$args
Primer-Linux-DebugGame.commands = $$build Primer Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Primer-Linux-Shipping.commands = $$build Primer Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Primer-Linux-Test.commands = $$build Primer Linux Test  -project="\"$$gameProjectFile\"" $$args
Primer.commands = $$build Primer Linux Development  -project="\"$$gameProjectFile\"" $$args

PrimerEditor-Linux-Debug.commands = $$build PrimerEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
PrimerEditor-Linux-DebugGame.commands = $$build PrimerEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
PrimerEditor-Linux-Shipping.commands = $$build PrimerEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
PrimerEditor-Linux-Test.commands = $$build PrimerEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
PrimerEditor.commands = $$build PrimerEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Primer-Linux-Debug \
	Primer-Linux-DebugGame \
	Primer-Linux-Shipping \
	Primer-Linux-Test \
	Primer \
	PrimerEditor-Linux-Debug \
	PrimerEditor-Linux-DebugGame \
	PrimerEditor-Linux-Shipping \
	PrimerEditor-Linux-Test \
	PrimerEditor \
